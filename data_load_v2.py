...
df8 = pd.read_csv('scen_3001-3300.CSV')
df9 = pd.read_csv('scen_3301-3600.CSV')
df10 = pd.read_csv('scen_3601-3900.CSV')
df11 = pd.read_csv('scen_3901-4200.CSV')
df12 = pd.read_csv('scen_4201-4700.CSV')
df13 = pd.read_csv('scen_4701-5000.CSV')
df14 = pd.read_csv('scen_5001-5236.CSV')
df15 = pd.read_csv('scen_6001-6300.CSV')
df16 = pd.read_csv('scen_6301-6600.CSV')
df17 = pd.read_csv('scen_6601-6900.CSV')
df18 = pd.read_csv('scen_6901-7200.CSV')
df19 = pd.read_csv('scen_7201-7500.CSV')
df20 = pd.read_csv('scen_7501-7800.CSV')
df21 = pd.read_csv('scen_7801-8236.CSV')
df22 = pd.read_csv('scen_9001-9300.CSV')
df23 = pd.read_csv('scen_9301-9700.CSV')
df24 = pd.read_csv('scen_9701-10000.CSV')
df25 = pd.read_csv('scen_10001-10300.CSV')
df26 = pd.read_csv('scen_10301-10600.CSV')
df27 = pd.read_csv('scen_10601-10900.CSV')
df28 = pd.read_csv('scen_10901-11236.CSV')
df29 = pd.read_csv('scen_12001-12300.CSV')
df30 = pd.read_csv('scen_12301-12600.CSV')
df31 = pd.read_csv('scen_12601-12900.CSV')
df32 = pd.read_csv('scen_12901-13200.CSV')
df33 = pd.read_csv('scen_13201-13500.CSV')
df34 = pd.read_csv('scen_13501-13800.CSV')
df35 = pd.read_csv('scen_13801-14236.CSV')
